...
const SideNavbar = () => {
  return (
    ...
    <>
      <div
        className="flex-none bg-gray-50 h-screen text-black"
        style={{ width: "250px", alignItems: "center" }}
      >
        <div className="flex justify-between px-6 py-8 items-center border-b">
          <div>
            <PersonIcon />
            <span className="pl-3">Hello User</span>
          </div>
          <div>
            <NotificationsIcon />
          </div>
